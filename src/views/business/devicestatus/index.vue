<template>
  <div class="app-container">
    <div class="top-container">
      <el-button style="margin-right: 20px;" type="success"  @click="updateDeviceStatus" v-hasPerm="['deviceStatus:add']">
        更新设备状态
      </el-button>
    ...
    <el-card style="margin-top: 10px">
      <el-table :data="tableDatalist" v-loading="loading" highlight-current-row border style="font-size: 10px;">
        ...
        <el-table-column prop="recordtime" label="记录时间" width="300"/>
      </el-table>
...
import {DeviceStatus} from "@/api/business/types";
const state = reactive({
  inputSearch: '',
  latestStatus: true,
  loading: false,
  total: 0,  // 总条数,
  tableDatalist: [{'devid': '1'}],
