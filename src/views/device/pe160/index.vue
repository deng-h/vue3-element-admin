<template>
  <div class="app-container">
    ...
    <el-card>
      <el-table :data="pe160List" v-loading="loading" highlight-current-row border style="font-size: 10px;">
...
import {Pe160Form, SearchTimeQuery} from "@/api/device/types";

const state = reactive({
  inputSearchTime: '',
  loading: false,
  total: 0,  // 总条数
  pe160List: [] as Pe160Form[],
