<template>
  <div class="app-container">
    ...
    <el-card>
      <el-table :data="pe63List" v-loading="loading" highlight-current-row border style="font-size: 10px;">
...
import {Pe63Form, SearchTimeQuery} from "@/api/device/types";

const state = reactive({
  inputSearchTime: '',
  loading: false,
  total: 0,  // 总条数
  pe63List: [] as Pe63Form[],
