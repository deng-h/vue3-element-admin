<template>
  <div class="app-container">
    ...
    <el-card>
      <el-table :data="mpp315List" v-loading="loading" highlight-current-row border style="font-size: 10px;">
        ...
        <el-table-column prop="mold12temp" label="模具12温度实测值" width="95"/>
        <el-table-column prop="mold12tmset" label="模具12温度设定值" width="95"/>
        <el-table-column prop="mold13temp" label="模具13温度实测值" width="95"/>
        <el-table-column prop="mold13tmset" label="模具13温度设定值" width="95"/>
...
import {Mpp315Form, SearchTimeQuery} from "@/api/device/types";

const state = reactive({
  inputSearchTime: '',
  loading: false,
  total: 0,  // 总条数
  mpp315List: [] as Mpp315Form[],
