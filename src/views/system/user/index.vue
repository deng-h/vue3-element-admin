...
import {Search, Plus, Refresh, Delete, Download, Top, UploadFilled} from '@element-plus/icons-vue';
import {UserForm, UserImportData, UserQuery, UserType} from '@/api/user/types';
...
const state = reactive({
  ...
  deptName: undefined,
  deptOptions: [] as OptionType[],  // 部门下拉项
  roleOptions: [] as OptionType[],  // 角色下拉项
  formData: {
    status: 1
  } as UserForm,
  queryParams: {
        ...
        <el-card>
          <template #header>
            <el-form-item style="float: left">
              ...
              <el-button type="danger" :icon="Delete" :disabled="ids.length === 0" @click="handleDelete" v-hasPerm="['sys:user:delete']">删除</el-button>
            </el-form-item>
            <el-form-item style="float: right">
              <el-dropdown split-button style="margin-left: 12px">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item :icon="Download" @click="handleDownloadTemplate">
                      下载模板
                    </el-dropdown-item>
              ...
              <el-button :icon="Download" style="margin-left: 12px" @click="handleExport">
                导出
              </el-button>
            </el-form-item>
          </template>
          ...
          <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="left" width="200">
              <template #default="scope">
                ...
                <el-button type="primary" link @click="handleUpdate(scope.row)" v-hasPerm="['sys:user:edit']">
                  编辑
                </el-button>
                <el-button type="danger" link @click="handleDelete(scope.row)" v-hasPerm="['sys:user:delete']">
                  删除
                </el-button>
              </template>
            </el-table-column>
